...
describe("AppNavbar tests", () => {
    ...
    test("renders the dining commons menu correctly for an admin", async () => {
    ...
    test("renders the menu item review correctly for a user", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
    ...
    test("renders the menu item review  correctly for an admin", async () => {
